...
p <- ggplot(data=a, aes(x=CHX_NOER_Nucl_vs_CHX_ER_Nucl.log2fc, y=-log10(CHX_NOER_Nucl_vs_CHX_ER_Nucl.worst_fdr), col=diffexpressed)) + 
  geom_point(shape = "circle",size = 1.5,alpha=1) +labs(x = "log2fc", y = "-log10(worst FDR)", title = "CHX_NOER vs CHX_ER", subtitle = "Nucleus",col="Differential expression") +theme_minimal()
...
ggsave("CHX_NOER vs CHX_ER Nucleus.png", 
